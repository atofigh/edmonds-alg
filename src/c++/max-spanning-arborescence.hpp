#ifndef MAX_SPANNING_ARBORESCENCE_HPP
#define MAX_SPANNING_ARBORESCENCE_HPP
#include <vector>

/** @mainpage Edmonds's algorithm ( edmonds-alg ) C++ Library Documentation
 *
 ...
 * (1980)). The function implements a variation optimized for dense
 * graphs with time complexity O(n^2), where n is the number of
 * vertices.
 *
...
void
max_spanning_arborescence(const Matrix          &weights,
                          unsigned               num_vertices,
                          unsigned               root,
                          std::vector<unsigned> &parent);


#define MAX_SPANNING_ARBORESCENCE
#include "common-opt.hpp"
#undef MAX_SPANNING_ARBORESCENCE

#endif /* MAX_SPANNING_ARBORESCENCE_HPP */
